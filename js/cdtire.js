        ...
        workbook.SheetNames.forEach((sheetName) => {
            ...
            for (let i = headerRowIndex + 1; i < jsonData.length; i++) {
                ...
                const rowObj = {
                    ...
                    inflation_pressure: rawP, // Store P2 text (not pressure value)
                    velocity: columns.velocity !== -1 ? cleanValue(row[columns.velocity]) : '',
                    preload: rawL, // Store L1 text (not load value)
                    ...
                    p: rawP, // Pass P2 as-is to database
                    l: rawL  // Pass L1 as-is to database
                };
